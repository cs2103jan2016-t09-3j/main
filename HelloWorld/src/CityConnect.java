...
public class CityConnect {
	...
	private static final String MESSAGE_WELCOME = "Welcome to SimpleRouteStore!";//change welcome message to message welcome to ensure consistency
	...
	private static final String MESSAGE_UNRECOGNIZED = "Unrecognized command type";
	private static final String MESSAGE_NULL = "command type string cannot be null!";
	private static final String MESSAGE_ADDROUTE = "addroute";
	private static final String MESSAGE_GETDISTANCE = "getdistance";
	private static final String MESSAGE_EXIT = "exit";
	private static final String MESSAGE_ROUTE_NULL = "Route end points cannot be null";
	...
	//These are the numbers for row and column in the string
	private static final int ROW = 10;
	private static final int COL = 3;
	// This array will be used to store the routes
	private static String[][] route = new String[ROW][COL];

	/*
	 * These are the locations at which various components of the route will be
	 * stored in the routes[][] array.
	 */
	//change all values to constants
	private static final int STORAGE_POSITION_START_LOCATION = PARAM_POSITION_START_LOCATION;
	private static final int STORAGE_POSITION_END_LOCATION = PARAM_POSITION_END_LOCATION;
	private static final int STORAGE_POSITION_DISTANCE = PARAM_POSITION_DISTANCE;
	...
	public static void main(String[] args) {
		//change welcome message to message welcome to ensure consistency
	...
	public static String executeCommand(String userCommand) {
		...
		default:
			...
			throw new Error(MESSAGE_UNRECOGNIZED);
		}
		/*
		 * ==============NOTE TO STUDENTS======================================
	...
	private static COMMAND_TYPE determineCommandType(String commandTypeString) {
		if (commandTypeString == null)
			throw new Error(MESSAGE_NULL);

		if (commandTypeString.equalsIgnoreCase(MESSAGE_ADDROUTE)) {
			return COMMAND_TYPE.ADD_ROUTE;
		} else if (commandTypeString.equalsIgnoreCase(MESSAGE_GETDISTANCE)) {
			return COMMAND_TYPE.GET_DISTANCE;
		} else if (commandTypeString.equalsIgnoreCase(MESSAGE_EXIT)) {
	...
	private static boolean sameRoute(String startLocation1,
		...
		if ((startLocation1 == null) || (endLocation1 == null)
			...
			throw new Error(MESSAGE_ROUTE_NULL);
		}
